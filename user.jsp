...
<!--						<a class="navbar-brand" href="#topWrap">
			...
			<div class="container-fluid">
				<div class="col-md-6 col-md-push-6 jumboText">
					<h2>User Login</h2>
  <form action="loginverify.jsp" style="color:black;" method="post" onsubmit="return s1();">
                    ...
                    <label style="font-size: 20px;margin-left: 70px;color:black;">password</label><input type="password" id="password" class="textbox" placeholder="" required style="margin-left: 37px;" name="pass"/><br /><br />
                    ...
                    <label style="font-size: 20px;margin-left: 70px;color:black;">Card No</label><input type="text" class="textbox" placeholder="" required style="margin-left: 55px;" name="acno"/><br /><br />
                     ...
                     <input type="submit" class="btn btn-info" style="margin-left: 150px" value="SignIn"/>
                     <input type="reset" class="btn btn-info" />
                     <a href="reg.jsp" class="btn btn-warning">Create New User</a>
                                 </div>
