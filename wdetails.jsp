	...
	<html lang="en">
        ...
        <%}
            ...
            <%
                    ...
                    acno = (String) session1.getAttribute("acno");
			...
			<div class="container-fluid">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select *from withdrawals where acno='"+acno+"'");
    ...
    <h2>Withdrawal details</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            ...
                            <%                  while (rt.next()) {
                                    ...
                                    String accno = rt.getString("acno");
                            ...
                            %>
                            <tr>
                                <td><%=uname%></td><td><%=accno%></td><td><%=bname%></td><td><%=deposit%></td><td><%=status%></td>
