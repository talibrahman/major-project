			...
			<div class="container-fluid">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select * from transaction where flag=1");
    ...
    <h2>Deposit details</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: grey">
                                <th align="center" width="5%" >NAME</th><br/><th>CARD NO</th><br/><th>BANK NAME</th><th>DEPOSIT</th><th style="text-align:center;">CRYPTO CURRENCY</th>
                            </tr>
                            <%                  while (rt.next()) {
                                    ...
                                    String deposit = rt.getString("amount");
                                    String status = rt.getString("crypto");


                            %>
                            <tr>
                                <td><%=uname%></td><td><%=acno%></td><td><%=bname%></td><td><%=deposit%></td><td style="text-align:center;"><%=status%></td>
