			...
			<div class="container-fluid">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select *from transaction where crypto='pending'");
    ...
    <h2>Transaction Process</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td>TID</td><td align="center" width="5%">NAME</td><br><td>CARD NO</td><br><td>BANK NAME</td><td>DEPOSIT</td><td>CRYPRO CURRENCY</td>
                            </tr>
                            <%                  
                              while (rt.next()) {
                                    ...
                                    //String status = rt.getString("crypto");
                            %>
                            <tr>
                                <td><%=id%></td><td><%=uname%></td><td><%=acno%></td><td><%=bname%></td><td><%=amount%></td>
                                
                            <b><td><a href="CryptoCurrency?tid=<%=id%>&acno=<%=acno%>&amt=<%=amount%>" style="color: yellow;">&nbsp;Create</a></td></b>
                            </tr>
                            <%
                                }
                                con.close();
