			...
			<div class="container-fluid">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select r.name,r.acno,r.cno,r.bname,t.amount,t.crypto,CASE t.flag when 0  then 'No' when 1  then 'Yes' END as status from register r,transaction t where r.name=t.name");
    ...
    <h2>Deposit details</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><td>Mobile No</td><td>CARD NO</td><td>BANK NAME</td><td>DEPOSIT</td><td>CRYPTO CURRENCY</td><td>ACTION</td><td>STATUS</td>
                            </tr>
                            <%      while (rt.next()) {
                                    ...
                                    String crypto = rt.getString("crypto");
                                    String status = rt.getString("status");
                            %>
                            <tr>
                                <td><%=uname%></td><td><%=cno%></td><td><%=acno%></td><td><%=bname%></td><td><%=amount%></td><td><input type="text" value=<%=crypto%> style="color:black;" spellcheck="false"/></td><td><a href="#">Send Crypto Currency</a></td><td><%=status%></td>
                            </tr>
                            <%
                                }
                                con.close();
