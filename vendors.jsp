			...
			<div class="container-fluid">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select name,pass,cno,bname,address,status from register where flag=2");
    ...
    <h2>VENDORS</h2>
                        <table style="border-style: solid;border-collapse: collapse" style="width:100%">
                            <tr style="background-color: burlywood">
                                <td width="5%">NAME</td><td>PASSWORD</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>STATUS</td>
                            </tr>
                            <%      while (rt.next()) {
